...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => $this->get('security.channel_listener'), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($a, array(0 => $b), 'main', $c, $d), 2 => $j, 3 => $m, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($a, $i, $g, $c, $d, true, $h), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($a, '575023b7ced294.12969065', $c, $g), 6 => $this->get('security.access_listener')), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($a, $this->get('security.authentication.trust_resolver'), $e, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $e, 'fos_user_security_login', true), 'error_403', NULL, $c, false));
    }
    ...
    public function getVichUploader_DownloadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['vich_uploader.download_handler'] = new VichUploaderBundleHandlerDownloadHandler_0000000060fa85c900000000daa966099beb70b74606b7aa0110bbea7013ae35(
    ...
    public function getVichUploader_UploadHandlerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['vich_uploader.upload_handler'] = new VichUploaderBundleHandlerUploadHandler_0000000060fa85d400000000daa966099beb70b74606b7aa0110bbea7013ae35(
                function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) use ($container) {
...
class VichUploaderBundleHandlerDownloadHandler_0000000060fa85c900000000daa966099beb70b74606b7aa0110bbea7013ae35 extends \Vich\UploaderBundle\Handler\DownloadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder575023be6f47d832606954 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer575023be6f866925801142 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties575023be6f47d441103295 = array(
    ...
    {
        $this->initializer575023be6f866925801142 && $this->initializer575023be6f866925801142->__invoke($this->valueHolder575023be6f47d832606954, $this, 'downloadObject', array('object' => $object, 'field' => $field, 'className' => $className, 'fileName' => $fileName), $this->initializer575023be6f866925801142);

        return $this->valueHolder575023be6f47d832606954->downloadObject($object, $field, $className, $fileName);
    }
    ...
    {
        $this->initializer575023be6f866925801142 = $initializer;
    }
    ...
    {
        $this->initializer575023be6f866925801142 && $this->initializer575023be6f866925801142->__invoke($this->valueHolder575023be6f47d832606954, $this, '__get', array('name' => $name), $this->initializer575023be6f866925801142);

        if (isset(self::$publicProperties575023be6f47d441103295[$name])) {
            return $this->valueHolder575023be6f47d832606954->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder575023be6f47d832606954;
    ...
    {
        $this->initializer575023be6f866925801142 && $this->initializer575023be6f866925801142->__invoke($this->valueHolder575023be6f47d832606954, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer575023be6f866925801142);
    ...
    {
        $this->initializer575023be6f866925801142 && $this->initializer575023be6f866925801142->__invoke($this->valueHolder575023be6f47d832606954, $this, '__isset', array('name' => $name), $this->initializer575023be6f866925801142);
    ...
    {
        $this->initializer575023be6f866925801142 && $this->initializer575023be6f866925801142->__invoke($this->valueHolder575023be6f47d832606954, $this, '__unset', array('name' => $name), $this->initializer575023be6f866925801142);
    ...
    {
        $this->initializer575023be6f866925801142 && $this->initializer575023be6f866925801142->__invoke($this->valueHolder575023be6f47d832606954, $this, '__clone', array(), $this->initializer575023be6f866925801142);

        $this->valueHolder575023be6f47d832606954 = clone $this->valueHolder575023be6f47d832606954;
    }

    public function __sleep()
    {
        $this->initializer575023be6f866925801142 && $this->initializer575023be6f866925801142->__invoke($this->valueHolder575023be6f47d832606954, $this, '__sleep', array(), $this->initializer575023be6f866925801142);

        return array('valueHolder575023be6f47d832606954');
    }
    ...
    {
        return $this->initializer575023be6f866925801142;
    }
    ...
    {
        return $this->initializer575023be6f866925801142 && $this->initializer575023be6f866925801142->__invoke($this->valueHolder575023be6f47d832606954, $this, 'initializeProxy', array(), $this->initializer575023be6f866925801142);
    }
    ...
    {
        return null !== $this->valueHolder575023be6f47d832606954;
    }
    ...
    {
        return $this->valueHolder575023be6f47d832606954;
    }


}

class VichUploaderBundleHandlerUploadHandler_0000000060fa85d400000000daa966099beb70b74606b7aa0110bbea7013ae35 extends \Vich\UploaderBundle\Handler\UploadHandler implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder575023be732ff474870233 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer575023be732ff881853588 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties575023be732ff568209681 = array(
    ...
    {
        $this->initializer575023be732ff881853588 && $this->initializer575023be732ff881853588->__invoke($this->valueHolder575023be732ff474870233, $this, 'upload', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer575023be732ff881853588);

        return $this->valueHolder575023be732ff474870233->upload($obj, $fieldName);
    }
    ...
    {
        $this->initializer575023be732ff881853588 && $this->initializer575023be732ff881853588->__invoke($this->valueHolder575023be732ff474870233, $this, 'inject', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer575023be732ff881853588);

        return $this->valueHolder575023be732ff474870233->inject($obj, $fieldName);
    }
    ...
    {
        $this->initializer575023be732ff881853588 && $this->initializer575023be732ff881853588->__invoke($this->valueHolder575023be732ff474870233, $this, 'clean', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer575023be732ff881853588);

        return $this->valueHolder575023be732ff474870233->clean($obj, $fieldName);
    }
    ...
    {
        $this->initializer575023be732ff881853588 && $this->initializer575023be732ff881853588->__invoke($this->valueHolder575023be732ff474870233, $this, 'remove', array('obj' => $obj, 'fieldName' => $fieldName), $this->initializer575023be732ff881853588);

        return $this->valueHolder575023be732ff474870233->remove($obj, $fieldName);
    }
    ...
    public function __construct($initializer)
    {
        $this->initializer575023be732ff881853588 = $initializer;
    }
    ...
    public function & __get($name)
    {
        $this->initializer575023be732ff881853588 && $this->initializer575023be732ff881853588->__invoke($this->valueHolder575023be732ff474870233, $this, '__get', array('name' => $name), $this->initializer575023be732ff881853588);

        if (isset(self::$publicProperties575023be732ff568209681[$name])) {
            return $this->valueHolder575023be732ff474870233->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder575023be732ff474870233;
    ...
    public function __set($name, $value)
    {
        $this->initializer575023be732ff881853588 && $this->initializer575023be732ff881853588->__invoke($this->valueHolder575023be732ff474870233, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer575023be732ff881853588);
    ...
    public function __isset($name)
    {
        $this->initializer575023be732ff881853588 && $this->initializer575023be732ff881853588->__invoke($this->valueHolder575023be732ff474870233, $this, '__isset', array('name' => $name), $this->initializer575023be732ff881853588);
    ...
    public function __unset($name)
    {
        $this->initializer575023be732ff881853588 && $this->initializer575023be732ff881853588->__invoke($this->valueHolder575023be732ff474870233, $this, '__unset', array('name' => $name), $this->initializer575023be732ff881853588);
    ...
    public function __clone()
    {
        $this->initializer575023be732ff881853588 && $this->initializer575023be732ff881853588->__invoke($this->valueHolder575023be732ff474870233, $this, '__clone', array(), $this->initializer575023be732ff881853588);

        $this->valueHolder575023be732ff474870233 = clone $this->valueHolder575023be732ff474870233;
    }

    public function __sleep()
    {
        $this->initializer575023be732ff881853588 && $this->initializer575023be732ff881853588->__invoke($this->valueHolder575023be732ff474870233, $this, '__sleep', array(), $this->initializer575023be732ff881853588);

        return array('valueHolder575023be732ff474870233');
    }
    ...
    public function getProxyInitializer()
    {
        return $this->initializer575023be732ff881853588;
    }
    ...
    public function initializeProxy()
    {
        return $this->initializer575023be732ff881853588 && $this->initializer575023be732ff881853588->__invoke($this->valueHolder575023be732ff474870233, $this, 'initializeProxy', array(), $this->initializer575023be732ff881853588);
    }
    ...
    public function isProxyInitialized()
    {
        return null !== $this->valueHolder575023be732ff474870233;
    }
    ...
    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder575023be732ff474870233;
    }
