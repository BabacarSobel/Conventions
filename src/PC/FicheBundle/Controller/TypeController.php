...
use PC\FicheBundle\Entity\Type;
use PC\FicheBundle\Form\TypeType;
...
class TypeController extends DefaultController
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('PCFicheBundle:Type:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PCFicheBundle:Type:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PCFicheBundle:Type')->find($id);
        ...
        return $this->render('PCFicheBundle:Type:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PCFicheBundle:Type:edit.html.twig', array(
            'entity'      => $entity,
