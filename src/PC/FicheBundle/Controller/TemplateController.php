...
class TemplateController extends DefaultController
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PCFicheBundle:Template')->findAll();

        return $this->render('PCFicheBundle:Template:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('PCFicheBundle:Template:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PCFicheBundle:Template')->find($id);
        ...
        return $this->render('PCFicheBundle:Template:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('PCFicheBundle:Template:edit.html.twig', array(
            'entity'      => $entity,
