...
class DemandeMADEvenementGratuitType extends AbstractType
{
    /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('activite','textarea')
            ->add('capaciteMaxSalles','integer',array('required' => true))
            ...
            ->add('nomReferent')
            ->add('prenomReferent')
            ->add('planificationEvenement','genemu_jqueryselect2_choice',array(
                                                        'choices' => array(
                                                            0 => 'oui',
                                                            1 => 'non',
                                                        ),'required' => true
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'PC\FicheBundle\Entity\MADEvenementGratuit'
        ));
    }
    ...
    {
        return 'pc_fichebundle_madevenementgratuit';
    }
}
